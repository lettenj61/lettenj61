...
var author$project$Home$wrapper = F2(
...
var author$project$Home$viewBottomMenu = function () {
	var tab = function (display) {
		return A2(
			elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('fas fa-4x fa-pastafarianism')
						]),
					_List_Nil)
				])),
			A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text('My name is Hideyuki Ueno.'),
					A2(elm$html$Html$br, _List_Nil, _List_Nil),
					elm$html$Html$text('I\'m making websites, (mostly) web based programs.')
				]))
		]));
...
var author$project$Home$viewNavbar = A2(
	elm$html$Html$nav,
	_List_fromArray(
		[
...
var author$project$Home$viewHomepage = A2(
	elm$html$Html$section,
	_List_fromArray(
		[
			elm$html$Html$Attributes$class('hero is-white')
		]),
	_List_fromArray(
		[
			A2(
			...
			'hero-head',
			_List_fromArray(
				[author$project$Home$viewNavbar])),
			A2(
			author$project$Home$wrapper,
			'hero-body',
			_List_fromArray(
			...
			'hero-foot',
			_List_fromArray(
				[author$project$Home$viewBottomMenu]))
		]));
var author$project$Home$view = function (_n0) {
	return author$project$Home$viewHomepage;
};
